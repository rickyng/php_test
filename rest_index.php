...
$tbl = new HTML_Table('', 'demoTbl');
			...
			foreach($users as $user):
				...
				$tbl->addCell('
					...
					');
				$tbl->addCell('
					<span class="editSpan email">'.$user['selling_price'].'</span>
					<input class="editInput email form-control input-sm" type="text" name="selling_price" value="'.$user['selling_price'].'" style="display: none;">
					');
				$tbl->addCell('
